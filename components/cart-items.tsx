...
export function CartItems() {
  const { cartDetails, removeItem, setItemQuantity, clearCart } = useShoppingCart()
  ...
  return (
    <ul
      role="list"
      className="divide-y divide-gray-200 border-t border-gray-200 dark:divide-gray-500 dark:border-gray-500"
    >
